...
public class MainActivity extends FlutterActivity implements ITransactionListener, MethodChannel.Result {
    ...
    public void configureFlutterEngine(@NonNull FlutterEngine flutterEngine) {
        ...
        // CHANNEL).setMethodCallHandler(hand);
    }
    ...
    private void openCheckoutUI(String checkoutId) {
        ...
        CheckoutSettings checkoutSettings = new CheckoutSettings(checkoutId, paymentBrands,
                Connect.ProviderMode.TEST).setShopperResultUrl("com.azooz.user://result");

        if (mode.equals("LIVE")) {
            checkoutSettings = new CheckoutSettings(checkoutId, paymentBrands,
                    Connect.ProviderMode.LIVE).setShopperResultUrl("com.azooz.user://result");
        }

        ComponentName componentName = new ComponentName(
               CheckoutBroadcastReceiver.class.getPackageName(), CheckoutBroadcastReceiver.class.getName());
    ...
    private void openCustomUI(String checkoutid) {
        ...
        if (STCPAY.equals("enabled")) {
            ...
            try {
                ...
                paymentParams.setShopperResultUrl("com.azooz.user://result");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (resultCode) {
            case CheckoutActivity.RESULT_OK:
                ...
                // sendStringMessageToFlutter(data.getStringExtra("roomName"));
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if  (intent.getScheme()!= null) {
            if (intent.getScheme().equals("com.azooz.user")) {
                success("success");
            } else {
                success("error");
            }
