     ...
     private func openCheckoutUI(checkoutId: String,result1: @escaping FlutterResult) {
        ...
        DispatchQueue.main.async{
            ...
            if self.brand == "mada" {
                ...
                let paymentRequest = OPPPaymentProvider.paymentRequest(withMerchantIdentifier: "merchant.Hyperpay.azooz", countryCode: "SA")
            ...
            checkoutSettings.shopperResultURL = "com.azooz.user://result"
    ...
    private func openCustomUI(checkoutId: String,result1: @escaping FlutterResult) {
        ...
        if self.STCPAY == "enabled" {
            ...
            do {
                ...
                params.shopperResultURL = "com.azooz.user://result"
...
//                let request = OPPPaymentProvider.paymentRequest(withMerchantIdentifier: "merchant.Hyperpay.azooz", countryCode: "SA")
//
...
//                request.paymentSummaryItems = [PKPaymentSummaryItem(label: "Azooz", amount: NSDecimalNumber(value: self.amount))]
//
//
//
...
//                      }
              ...
              print(amount)
                request.paymentSummaryItems = [PKPaymentSummaryItem(label: "Service Fee", amount: amount) , PKPaymentSummaryItem(label: "Azooz", amount: amount)]
                DispatchQueue.main.async {
                    if let vc = PKPaymentAuthorizationViewController(paymentRequest: request) as PKPaymentAuthorizationViewController? {
                    vc.delegate = self
                    self.window?.rootViewController?.present(vc, animated: true, completion: nil)
...
//                                self.createalart(titletext: error as? String, msgtext: "")
        ...
        override func application(_ app: UIApplication, open url: URL, options: [UIApplication.OpenURLOptionsKey : Any] = [:]) -> Bool {
            ...
            if url.scheme?.caseInsensitiveCompare("com.azooz.user") == .orderedSame {
